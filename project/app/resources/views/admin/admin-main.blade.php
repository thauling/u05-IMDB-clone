                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                            ...
                                            <td class="flex flex-col">
                                                ...
                                                <span class="text-red-600 font-bold">OK ?</span>
                                                @endif
                                                <a class="w-12 shadow bg-gray-500 hover:bg-gray-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-1 rounded" href="{{url('edit-review',$review->id)}}">Edit</a>
