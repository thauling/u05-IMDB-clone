...
<x-admin>
    <section class="flex flex-col items-center">
        <div class="flex flex-col p-10">
            <h1 class="block text-gray-500 font-bold">Find movie by title or abstract</h1>
            ...
            <div class="">
                <form class="w-full max-w-sm" method="get" action="">
                    ...
                    <div class="block" id="dynaForm">
                        <label for="dynaInput[0][row]" class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4">Edit cast of {{$movie->title}}</label>
