                        ...
                        <fieldset>
                            <span class="star-cb-group">
                                <input id="rating-10" type="radio" name="movie_rating" value="10" /><label
                                    for="rating-10">10</label>
                                <input id="rating-9" type="radio" name="movie_rating" value="9" /><label
                                    for="rating-9">9</label>
                                <input id="rating-8" type="radio" name="movie_rating" value="8" /><label
                                    for="rating-8">8</label>
                                <input id="rating-7" type="radio" name="movie_rating" value="7" /><label
                                    for="rating-7">7</label>
                                <input id="rating-6" type="radio" name="movie_rating" value="6" /><label
                                    for="rating-6">6</label>
                                <input id="rating-5" type="radio" name="movie_rating" value="5" /><label
                                    for="rating-5">5</label>
                                <input id="rating-4" type="radio" name="movie_rating" value="4" /><label
                                    for="rating-4">4</label>
                                <input id="rating-3" type="radio" name="movie_rating" value="3" /><label
                                    for="rating-3">3</label>
                                <input id="rating-2" type="radio" name="movie_rating" value="2" /><label
                                    for="rating-2">2</label>
                                <input id="rating-1" type="radio" name="movie_rating" value="1" /><label
